...
test_that("get_elev_point returns correctly", {
  ...
  epqs_sf <- get_elev_point(locations = sp_sf, src = "epqs")
  ...
  epqs_sf_aws <- get_elev_point(locations = sp_sf, src = "aws")
  epqs_sp_prj_aws <- get_elev_point(locations = sp_sm_prj, src = "aws")
  epqs_ft_aws <- get_elev_point(locations = sp_sm, src = "aws", units = "feet")
  epqs_m_aws <- get_elev_point(locations = sp_sm, src = "aws", units = "meters")
